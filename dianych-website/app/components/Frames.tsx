...
// Допоміжний компонент для картки з рамкою
...
const Frames = () => {
    const frameData = [
        { title: "Маленька рама", images: ['/images/frames/small_1_1.jpg', '/images/frames/small_1_2.jpg'], size: "під п'яльця 8 см", price: "450 UAH" },
        { title: "Маленька рама - 2", images: ['/images/frames/small_2_1.jpg', '/images/frames/small_2_2.jpg'], size: "під п'яльця 10 см", price: "500 UAH" },
        { title: "Середня рама", images: ['/images/frames/medium_1.jpg', '/images/frames/medium_2.jpg'], size: "під п'яльця 14 см", price: "600 UAH" },
        { title: "Велика рама", images: ['/images/frames/large_1.jpg', '/images/frames/large_2.jpg'], size: "під п'яльця 19 см", price: "700 UAH" }
    ];

    return (
        <section id="frames" className="py-12 bg-white">
            <div className="container mx-auto px-4">
                <h2 className="text-3xl font-bold text-center mb-8">Рамки</h2>
